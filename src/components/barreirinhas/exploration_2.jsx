...
function exploration_2({ isOpen, onClose }) {
  ...
  return (
    <div className="barreirinhas_exploration_2-overlay" onClick={onClose}>
      <div className="barreirinhas_exploration_2-container" onClick={(e) => e.stopPropagation()}>
        <div className="barreirinhas_exploration_2-arrow" />
        <div className="barreirinhas_exploration_2-card">
          <div className="barreirinhas_exploration_2-content">
            {/* Header Section */}
            <div className="barreirinhas_exploration_2-header">
              <div className="barreirinhas_exploration_2-status-section">
                <div className="barreirinhas_exploration_2-status-badge">
                  <div className="barreirinhas_exploration_2-status-icon">
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17.9999 31.7884C16.1269 31.7884 14.5337 31.1316 13.2202 29.8181C11.9067 28.5046 11.2499 26.9114 11.2499 25.0384C11.2499 23.1654 11.9067 21.5721 13.2202 20.2586C14.5337 18.9451 16.1269 18.2884 17.9999 18.2884C19.8729 18.2884 21.4662 18.9451 22.7797 20.2586C24.0932 21.5721 24.7499 23.1654 24.7499 25.0384C24.7499 26.9114 24.0932 28.5046 22.7797 29.8181C21.4662 31.1316 19.8729 31.7884 17.9999 31.7884ZM10.5288 17.6767L4.09607 11.2155C5.99032 9.44623 8.13269 8.08661 10.5232 7.13661C12.9134 6.18661 15.4057 5.71161 17.9999 5.71161C20.5942 5.71161 23.0864 6.18661 25.4767 7.13661C27.8672 8.08661 30.0096 9.44623 31.9038 11.2155L25.4711 17.6767C24.4366 16.7287 23.2818 15.9975 22.0068 15.483C20.7318 14.9687 19.3962 14.7116 17.9999 14.7116C16.6037 14.7116 15.2681 14.9687 13.9931 15.483C12.7181 15.9975 11.5633 16.7287 10.5288 17.6767Z" fill="white"/>
                    </svg>
                  </div>
                  <span className="barreirinhas_exploration_2-status-text">Em exploração</span>
                </div>
                <h1 className="barreirinhas_exploration_2-title">Bacia de Barreirinhas</h1>
              </div>

              {/* Info Section */}
              <div className="barreirinhas_exploration_2-info-grid">
                <div className="barreirinhas_exploration_2-info-item">
                  <div className="barreirinhas_exploration_2-info-label">
                    <div className="barreirinhas_exploration_2-info-icon">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="barreirinhas_exploration_2-info-label-text">Operadora</span>
                  </div>
                  <div className="barreirinhas_exploration_2-info-details">
                    <div className="barreirinhas_exploration_2-info-value">Shell</div>
                    <div className="barreirinhas_exploration_2-info-description">Responsável pela administração do campo</div>
                  </div>
                </div>
                ...
                <div className="barreirinhas_exploration_2-info-item">
                  <div className="barreirinhas_exploration_2-info-label">
                    ...
                    <span className="barreirinhas_exploration_2-info-label-text">Profundidade</span>
                  </div>
                  <div className="barreirinhas_exploration_2-info-details">
                    <div className="barreirinhas_exploration_2-info-value">~2.500-4.000m</div>
                    <div className="barreirinhas_exploration_2-info-description">Distância da superfície do mar até o fundo</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="barreirinhas_exploration_2-participation">
              <h2 className="barreirinhas_exploration_2-participation-title">Participação das empresas</h2>
              <div className="barreirinhas_exploration_2-companies">
                {companyData.map((company) => (
                  <div key={company.id} className="barreirinhas_exploration_2-company">
                    <div className="barreirinhas_exploration_2-company-header">
                      <span className={`barreirinhas_exploration_2-company-name ${company.isOperator ? 'operator' : ''}`}>
                        {company.name}
                      </span>
                      <span className="barreirinhas_exploration_2-company-percentage">
                        {company.percentage}%
                      </span>
                    </div>
                    <div className="barreirinhas_exploration_2-progress-bar">
                      <div 
                        className="barreirinhas_exploration_2-progress-fill"
                        style={{
            ...
            {/* Close Button */}
            <button className="barreirinhas_exploration_2-close-button" onClick={onClose}>
              Fechar
            </button>
          </div>
        </div>
