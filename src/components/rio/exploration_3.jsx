...
function exploration_3({ isOpen, onClose }) {
  ...
  return (
    <div className="exploration_3-overlay" onClick={onClose}>
      <div className="exploration_3-container" onClick={(e) => e.stopPropagation()}>
        <div className="exploration_3-arrow" />
        <div className="exploration_3-card">
          <div className="exploration_3-content">
            {/* Header Section */}
            <div className="exploration_3-header">
              <div className="exploration_3-status-section">
                <div className="exploration_3-status-badge">
                  <div className="exploration_3-status-icon">
                  ...
                  <span className="exploration_3-status-text">Em exploração</span>
                </div>
                <h1 className="exploration_3-title">S-M-1821, S-M-1819, S-M-1914, S-M-1912</h1>
              </div>

              {/* Info Section */}
              <div className="exploration_3-info-grid">
                <div className="exploration_3-info-item">
                  <div className="exploration_3-info-label">
                    <div className="exploration_3-info-icon">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="exploration_3-info-label-text">Operadora</span>
                  </div>
                  <div className="exploration_3-info-details">
                    <div className="exploration_3-info-value">Shell</div>
                    <div className="exploration_3-info-description">Responsável pela administração do campo</div>
                  </div>
                </div>
                ...
                <div className="exploration_3-info-item">
                  <div className="exploration_3-info-label">
                    ...
                    <span className="exploration_3-info-label-text">Profundidade</span>
                  </div>
                  <div className="exploration_3-info-details">
                    <div className="exploration_3-info-value">A definir</div>
                    <div className="exploration_3-info-description">Distância da superfície do mar até o fundo</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="exploration_3-participation">
              <h2 className="exploration_3-participation-title">Participação das empresas</h2>
              <div className="exploration_3-companies">
                {companyData.map((company) => (
                  <div key={company.id} className="exploration_3-company">
                    <div className="exploration_3-company-header">
                      <span className={`exploration_3-company-name ${company.isOperator ? 'operator' : ''}`}>
                        {company.name}
                      </span>
                      <span className="exploration_3-company-percentage">
                        {company.percentage}%
                      </span>
                    </div>
                    <div className="exploration_3-progress-bar">
                      <div 
                        className="exploration_3-progress-fill"
                        style={{
            ...
            {/* Close Button */}
            <button className="exploration_3-close-button" onClick={onClose}>
              Fechar
            </button>
          </div>
        </div>
