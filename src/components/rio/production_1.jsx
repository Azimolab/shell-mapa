  ...
  return (
    <div className="production_1-overlay" onClick={onClose}>
      <div className="production_1-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="production_1-card">
          <div className="production_1-content">
            {/* Header Section */}
            <div className="production_1-header">
              <div className="production_1-status-section">
                <div className="production_1-status-badge">
                  <div className="production_1-status-icon">
                  ...
                  <span className="production_1-status-text">Em produção</span>
                </div>
                <h1 className="production_1-title">Bijupirá & Salema</h1>
              </div>

              {/* Info Section */}
              <div className="production_1-info-grid">
                <div className="production_1-info-item">
                  <div className="production_1-info-label">
                    <div className="production_1-info-icon">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="production_1-info-label-text">Operadora</span>
                  </div>
                  <div className="production_1-info-details">
                    <div className="production_1-info-value">Shell</div>
                    <div className="production_1-info-description">Responsável pela administração do campo</div>
                  </div>
                </div>
                ...
                <div className="production_1-info-item">
                  <div className="production_1-info-label">
                    ...
                    <span className="production_1-info-label-text">Profundidade</span>
                  </div>
                  <div className="production_1-info-details">
                    <div className="production_1-info-value">~400-870m</div>
                    <div className="production_1-info-description">Distância da superfície do mar até o fundo</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Divider */}
            <div className="production_1-divider" />

            {/* Company Participation Section */}
            <div className="production_1-participation">
              <h2 className="production_1-participation-title">Participação das empresas</h2>
              <div className="production_1-companies">
                {companyData.map((company) => (
                  <div key={company.id} className="production_1-company">
                    <div className="production_1-company-header">
                      <span className={`production_1-company-name ${company.isOperator ? 'operator' : ''}`}>
                        {company.name}
                      </span>
                      <span className="production_1-company-percentage">
                        {company.percentage}%
                      </span>
                    </div>
                    <div className="production_1-progress-bar">
                      <div 
                        className="production_1-progress-fill"
                        style={{
            ...
            <div className="production_1-infrastructure">
              <h2 className="production_1-infrastructure-title">Infraestrutura associada</h2>
              <div className="production_1-infrastructure-content">
                <div className="production_1-fpso-info">
                  <div className="production_1-fpso-title">1 FPSO em operação</div>
                  <div className="production_1-fpso-description">Unidade flutuante de produção, armazenamento e transferência de petróleo</div>
                </div>
                <div className="production_1-bullet-item">
                  <div className="production_1-bullet-number">
                    <span>1</span>
                  </div>
                  <span className="production_1-bullet-text">Fluminense</span>
                </div>
              </div>
            </div>

            {/* Close Button */}
            <button className="production_1-close-button" onClick={onClose}>
              Fechar
            </button>
          </div>
        </div>
