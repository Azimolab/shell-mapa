  ...
  return (
    <div className="exploration_2-overlay" onClick={onClose}>
      <div className="exploration_2-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="exploration_2-card">
          <div className="exploration_2-content">
            {/* Header Section */}
            <div className="exploration_2-header">
              <div className="exploration_2-status-section">
                <div className="exploration_2-status-badge">
                  <div className="exploration_2-status-icon">
                  ...
                  <span className="exploration_2-status-text">Em exploração</span>
                </div>
                <h1 className="exploration_2-title">S-M-1707, S-M-1709, S-M-1715, S-M-1717, S-M-1719</h1>
              </div>

              {/* Info Section */}
              <div className="exploration_2-info-grid">
                <div className="exploration_2-info-item">
                  <div className="exploration_2-info-label">
                    <div className="exploration_2-info-icon">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="exploration_2-info-label-text">Operadora</span>
                  </div>
                  <div className="exploration_2-info-details">
                    <div className="exploration_2-info-value">Shell</div>
                    <div className="exploration_2-info-description">Responsável pela administração do campo</div>
                  </div>
                </div>
                ...
                <div className="exploration_2-info-item">
                  <div className="exploration_2-info-label">
                    ...
                    <span className="exploration_2-info-label-text">Profundidade</span>
                  </div>
                  <div className="exploration_2-info-details">
                    <div className="exploration_2-info-value">A definir</div>
                    <div className="exploration_2-info-description">Distância da superfície do mar até o fundo</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="exploration_2-participation">
              <h2 className="exploration_2-participation-title">Participação das empresas</h2>
              <div className="exploration_2-companies">
                {companyData.map((company) => (
                  <div key={company.id} className="exploration_2-company">
                    <div className="exploration_2-company-header">
                      <span className={`exploration_2-company-name ${company.isOperator ? 'operator' : ''}`}>
                        {company.name}
                      </span>
                      <span className="exploration_2-company-percentage">
                        {company.percentage}%
                      </span>
                    </div>
                    <div className="exploration_2-progress-bar">
                      <div 
                        className="exploration_2-progress-fill"
                        style={{
            ...
            {/* Close Button */}
            <button className="exploration_2-close-button" onClick={onClose}>
              Fechar
            </button>
          </div>
        </div>
