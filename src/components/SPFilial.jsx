...
const SPFilial = () => {
  return (
    <div className="sp-filial">
      <div className="sp-filial__pin">
        <div className="sp-filial__icon">
        ...
        <h3 className="sp-filial__title">São Paulo</h3>
      </div>
      <div className="sp-filial__arrow">
