...
function exploration_1({ isOpen, onClose }) {
  ...
  return (
    <div className="potiguar_exploration_1-overlay" onClick={onClose}>
      <div className="potiguar_exploration_1-container" onClick={(e) => e.stopPropagation()}>
        <div className="potiguar_exploration_1-arrow" />
        <div className="potiguar_exploration_1-card">
          <div className="potiguar_exploration_1-content">
            {/* Header Section */}
            <div className="potiguar_exploration_1-header">
              <div className="potiguar_exploration_1-status-section">
                <div className="potiguar_exploration_1-status-badge">
                  <div className="potiguar_exploration_1-status-icon">
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M18.0001 31.7884C16.1271 31.7884 14.5338 31.1317 13.2203 29.8182C11.9068 28.5047 11.2501 26.9114 11.2501 25.0384C11.2501 23.1654 11.9068 21.5722 13.2203 20.2587C14.5338 18.9452 16.1271 18.2884 18.0001 18.2884C19.8731 18.2884 21.4663 18.9452 22.7798 20.2587C24.0933 21.5722 24.7501 23.1654 24.7501 25.0384C24.7501 26.9114 24.0933 28.5047 22.7798 29.8182C21.4663 31.1317 19.8731 31.7884 18.0001 31.7884ZM10.5289 17.6768L4.09619 11.2155C5.99044 9.4463 8.13282 8.08667 10.5233 7.13667C12.9136 6.18667 15.4058 5.71167 18.0001 5.71167C20.5943 5.71167 23.0866 6.18667 25.4768 7.13667C27.8673 8.08667 30.0097 9.4463 31.9039 11.2155L25.4712 17.6768C24.4367 16.7288 23.2819 15.9975 22.0069 15.483C20.7319 14.9688 19.3963 14.7117 18.0001 14.7117C16.6038 14.7117 15.2682 14.9688 13.9932 15.483C12.7182 15.9975 11.5634 16.7288 10.5289 17.6768Z" fill="white"/>
                    </svg>
                  </div>
                  <span className="potiguar_exploration_1-status-text">Em exploração</span>
                </div>
                <h1 className="potiguar_exploration_1-title">Bacia Potiguar</h1>
              </div>

              {/* Info Section */}
              <div className="potiguar_exploration_1-info-grid">
                <div className="potiguar_exploration_1-info-item">
                  <div className="potiguar_exploration_1-info-label">
                    <div className="potiguar_exploration_1-info-icon">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="potiguar_exploration_1-info-label-text">Operadora</span>
                  </div>
                  <div className="potiguar_exploration_1-info-details">
                    <div className="potiguar_exploration_1-info-value">Shell</div>
                    <div className="potiguar_exploration_1-info-description">Responsável pela administração do campo</div>
                  </div>
                </div>
                ...
                <div className="potiguar_exploration_1-info-item">
                  <div className="potiguar_exploration_1-info-label">
                    ...
                    <span className="potiguar_exploration_1-info-label-text">Profundidade</span>
                  </div>
                  <div className="potiguar_exploration_1-info-details">
                    <div className="potiguar_exploration_1-info-value">~2.500-4.000m</div>
                    <div className="potiguar_exploration_1-info-description">Distância da superfície do mar até o fundo</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="potiguar_exploration_1-participation">
              <h2 className="potiguar_exploration_1-participation-title">Participação das empresas</h2>
              <div className="potiguar_exploration_1-companies">
                {companyData.map((company) => (
                  <div key={company.id} className="potiguar_exploration_1-company">
                    <div className="potiguar_exploration_1-company-header">
                      <span className={`potiguar_exploration_1-company-name ${company.isOperator ? 'operator' : ''}`}>
                        {company.name}
                      </span>
                      <span className="potiguar_exploration_1-company-percentage">
                        {company.percentage}%
                      </span>
                    </div>
                    <div className="potiguar_exploration_1-progress-bar">
                      <div 
                        className="potiguar_exploration_1-progress-fill"
                        style={{
            ...
            {/* Close Button */}
            <button className="potiguar_exploration_1-close-button" onClick={onClose}>
              Fechar
            </button>
          </div>
        </div>
