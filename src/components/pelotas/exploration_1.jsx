  ...
  return (
    <div className="pelotas_exploration_1-overlay" onClick={onClose}>
      <div className="pelotas_exploration_1-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="pelotas_exploration_1-card">
          <div className="pelotas_exploration_1-content">
            {/* Header Section */}
            <div className="pelotas_exploration_1-header">
              <div className="pelotas_exploration_1-status-section">
                <div className="pelotas_exploration_1-status-badge">
                  <div className="pelotas_exploration_1-status-icon">
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M18.0001 31.7882C16.1271 31.7882 14.5338 31.1314 13.2203 29.8179C11.9068 28.5044 11.2501 26.9112 11.2501 25.0382C11.2501 23.1652 11.9068 21.5719 13.2203 20.2584C14.5338 18.9449 16.1271 18.2882 18.0001 18.2882C19.8731 18.2882 21.4663 18.9449 22.7798 20.2584C24.0933 21.5719 24.7501 23.1652 24.7501 25.0382C24.7501 26.9112 24.0933 28.5044 22.7798 29.8179C21.4663 31.1314 19.8731 31.7882 18.0001 31.7882ZM10.5289 17.6766L4.09619 11.2153C5.99044 9.44605 8.13282 8.08643 10.5233 7.13643C12.9136 6.18643 15.4058 5.71143 18.0001 5.71143C20.5943 5.71143 23.0866 6.18643 25.4768 7.13643C27.8673 8.08643 30.0097 9.44605 31.9039 11.2153L25.4712 17.6766C24.4367 16.7286 23.2819 15.9973 22.0069 15.4828C20.7319 14.9686 19.3963 14.7114 18.0001 14.7114C16.6038 14.7114 15.2682 14.9686 13.9932 15.4828C12.7182 15.9973 11.5634 16.7286 10.5289 17.6766Z" fill="white"/>
                    </svg>
                  </div>
                  <span className="pelotas_exploration_1-status-text">Em exploração</span>
                </div>
                <div className="pelotas_exploration_1-title-section">
                  <h1 className="pelotas_exploration_1-title">Bacia Pelotas</h1>
                  <div className="pelotas_exploration_1-auction-badge">
                    <span className="pelotas_exploration_1-auction-text">Rodada de licitação: OPC4</span>
                  </div>
                </div>
              </div>

              {/* Info Section */}
              <div className="pelotas_exploration_1-info-grid">
                <div className="pelotas_exploration_1-info-item">
                  <div className="pelotas_exploration_1-info-label">
                    <div className="pelotas_exploration_1-info-icon">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="pelotas_exploration_1-info-label-text">Operadora</span>
                  </div>
                  <div className="pelotas_exploration_1-info-details">
                    <div className="pelotas_exploration_1-info-value">Petrobrás</div>
                    <div className="pelotas_exploration_1-info-description">Responsável pela administração do campo</div>
                  </div>
                </div>
                ...
                <div className="pelotas_exploration_1-info-item">
                  <div className="pelotas_exploration_1-info-label">
                    ...
                    <span className="pelotas_exploration_1-info-label-text">Profundidade</span>
                  </div>
                  <div className="pelotas_exploration_1-info-details">
                    <div className="pelotas_exploration_1-info-value">A definir</div>
                    <div className="pelotas_exploration_1-info-description">Distância da superfície do mar até o fundo</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pelotas_exploration_1-participation">
              <h2 className="pelotas_exploration_1-participation-title">Participação das empresas</h2>
              <div className="pelotas_exploration_1-companies">
                {companyData.map((company) => (
                  <div key={company.id} className="pelotas_exploration_1-company">
                    <div className="pelotas_exploration_1-company-header">
                      <span className={`pelotas_exploration_1-company-name ${company.isOperator ? 'operator' : ''}`}>
                        {company.name}
                      </span>
                      <span className="pelotas_exploration_1-company-percentage">
                        {company.percentage}%
                      </span>
                    </div>
                    <div className="pelotas_exploration_1-progress-bar">
                      <div 
                        className="pelotas_exploration_1-progress-fill"
                        style={{
            ...
            {/* Close Button */}
            <button className="pelotas_exploration_1-close-button" onClick={onClose}>
              Fechar
            </button>
          </div>
        </div>
